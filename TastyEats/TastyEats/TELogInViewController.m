...
- (void)handleLogInError:(NSError *)error {
    if (error) {
        ...
        NSString *title = NSLocalizedString(@"Login Error", @"Login error title in TELogInViewController");
        NSString *message = NSLocalizedString(@"Something went wrong. Please try again.", @"Login error message in TELogInViewController");
